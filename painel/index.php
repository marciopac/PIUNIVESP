			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;" id="aside-navbar">
				<nav class="navbar navbar-inverse" >
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class=""></span> Sistema Integrador<span class="dashboard_text"></span></a></h1>
					</div>
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo $menu_dashboard ?>">
								<a href="#">
								...
								<ul class="treeview-menu">
									<li class="<?php echo $vendas_diarias_pagina ?>"><a href="vendas_diarias_pagina"><i class="fa fa-angle-right"></i> Vendas Diarias</a></li>
									
								</ul>
								<ul class="treeview-menu">
									<li class="<?php echo $vendas_mensais_pagina ?>"><a href="vendas_mensais_pagina"><i class="fa fa-angle-right"></i> Vendas Mensais</a></li>
									
								</ul>
								<ul class="treeview-menu">
								<li class="<?php echo $vendas_anuais_pagina ?>"><a href="vendas_anuais_pagina"><i class="fa fa-angle-right"></i> Vendas Anuais</a></li>
									
								</ul>
								<ul class="treeview-menu">
									<li class="<?php echo $usuarios ?>"><a href="comparativo_vendas_mensais"><i class="fa fa-angle-right"></i> Vendas - Comparativo Mensal</a></li>
									
								</ul>
								<ul class="treeview-menu">
									<li class="<?php echo $usuarios ?>"><a href="comparativo_vendas_anuais"><i class="fa fa-angle-right"></i> Vendas - Comparativo Anual</a></li>
									
								</ul>
								<ul class="treeview-menu">
									<li class="<?php echo $usuarios ?>"><a href="evolutivo_vendas"><i class="fa fa-angle-right"></i> Evolutivo de Vendas</a></li>
